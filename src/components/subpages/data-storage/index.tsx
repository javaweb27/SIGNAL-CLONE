...
const DataStorage = () => {
  return (
    <>
      ...
      <section>
        <SubpageLink to="" title={<LangText {...texts.manageStorage} />}>
          0 B
        </SubpageLink>
        <hr />
        <h4 className="subpage-section-title">
          <LangText {...texts.subtitleMediaAutoDL} />
        </h4>
        ...
        <p>
          <LangText {...texts.descriptionUseLessData} />
        </p>
        <hr />

        <h4 className="subpage-section-title">
          <LangText {...texts.subtitleProxy} />
        </h4>
